...
import com.lauwba.pabj.databinding.ActivityLetsPlayBinding
import com.lauwba.pabj.databinding.ItemGambarAdapterBinding
...
class LetsPlayActivity : AppCompatActivity() {
    ...
    private val onPageListener = object : ViewPager.OnPageChangeListener {
        //karena fungsinya harus ada tapi tidak di pakai maka akan di kembalikan ke Public functions Unit
